...
export default function MarketReview() {
    ...
    // Fixed handleUpdate function with proper typing
                    ...
                    <div className="max-w-2xl mx-auto relative">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-32 py-4 rounded-2xl bg-white text-gray-900 placeholder-gray-600 border-2 border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-lg"
                            />
                            <button
                                onClick={handleSearch}
                                className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-colors font-semibold shadow-lg"
                            >
                                Search
                            </button>
                        </div>
                    </div>
                </div> {/* Added missing closing div for header section */}
            </div> {/* Added missing closing div for header section */}
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                        {categories.map((category) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-full transition-all ${selectedCategory === category.toLowerCase()
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {featuredBusinesses.map((business) => (
                        <div key={business.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 relative">
                            {/* Admin controls */}
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="text-sm text-gray-600">{business.rating}/5</div>
                                </div>
                            </div>
                            ...
                            <div className="mb-4">
                                <span className="text-gray-600 text-sm">Recommend:</span>
                                <span className="font-semibold ml-2">{business.recommend}</span>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {recentReviews.map((review) => (
                            <div key={review.id} className="bg-gray-50 rounded-2xl p-6 hover:shadow-md transition-shadow relative">
                                {/* Admin controls */}
                                <div className="absolute top-4 right-4 flex gap-2">
                                    <button
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <h3 className="font-bold text-lg text-gray-900">{review.business}</h3>
                                        <p className="text-gray-500 text-sm">{review.category}</p>
                                    </div>
                                    <div className="flex items-center space-x-1">
                                        {[...Array(5)].map((_, i) => (
                                            <Star
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <button
                        ...
                        className="bg-white text-blue-600 px-8 py-3 rounded-xl hover:bg-gray-100 transition-colors font-semibold text-lg"
                    >
                        PUBLISH MY REVIEW
                    </button>
                </div>
