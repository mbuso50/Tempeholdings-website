        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-5 py-2.5">
              ...
              <span className="text-sm">Trusted by 200+ South African Brands</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="group bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-2xl flex items-center justify-center space-x-2 hover:bg-white/20 transition-all font-semibold">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/20">
              <div>
                <div className="text-white text-2xl font-bold mb-1">15+</div>
                <p className="text-blue-200 text-sm">Years</p>
              </div>
              <div>
                <div className="text-white text-2xl font-bold mb-1">500+</div>
          ...
          <div className="relative hidden lg:block">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="relative rounded-2xl overflow-hidden h-48 group">
                  <img
                    src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxqb2hhbm5lc2J1cmclMjBjaXR5c2NhcGV8ZW58MXx8fHwxNzYwMTAyMDQ2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                    alt="Johannesburg"
              ...
              <div className="space-y-4 pt-12">
                <div className="relative rounded-2xl overflow-hidden h-64 group">
                  <img
                    src="https://images.unsplash.com/photo-1531482615713-2afd69097998?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWFtJTIwbWVldGluZyUyMGJyYWluc3Rvcm18ZW58MXx8fHwxNzYwMTAyMDQ3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                    alt="Team Meeting"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-900/50 to-transparent"></div>
                ...
                <div className="relative rounded-2xl overflow-hidden h-48 group">
                  <img
                    src="https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYXB0b3AlMjBjcmVhdGl2ZSUyMHdvcmt8ZW58MXx8fHwxNzYwMTAyMDQ3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                    alt="Creative Work"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-900/50 to-transparent"></div>
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 shadow-2xl">
              ...
              <p className="text-gray-500 text-sm">From 200+ Reviews</p>
            </div>
          </div>
        </div>
      </div>
